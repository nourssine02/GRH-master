...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Form\\AvanceType' => ['privates', 'App\\Form\\AvanceType', 'getAvanceTypeService', true],
            'App\\Form\\CongesType' => ['privates', 'App\\Form\\CongesType', 'getCongesTypeService', true],
            'App\\Form\\EditProfilType' => ['privates', 'App\\Form\\EditProfilType', 'getEditProfilTypeService', true],
            'App\\Form\\EmployeType' => ['privates', 'App\\Form\\EmployeType', 'getEmployeTypeService', true],
            'App\\Form\\FichePaieType' => ['privates', 'App\\Form\\FichePaieType', 'getFichePaieTypeService', true],
            'App\\Form\\GestionSuppType' => ['privates', 'App\\Form\\GestionSuppType', 'getGestionSuppTypeService', true],
            'App\\Form\\MissionType' => ['privates', 'App\\Form\\MissionType', 'getMissionTypeService', true],
            'App\\Form\\PointageType' => ['privates', 'App\\Form\\PointageType', 'getPointageTypeService', true],
            ...
            'App\\Form\\AvanceType' => '?',
            'App\\Form\\CongesType' => '?',
            'App\\Form\\EditProfilType' => '?',
            'App\\Form\\EmployeType' => '?',
            'App\\Form\\FichePaieType' => '?',
            'App\\Form\\GestionSuppType' => '?',
