...
class __TwigTemplate_eddf8f101c336f45cdb91e66bc89d4f8bec475e05f66bb75106034937e3f68e9 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <p>
        The requested page couldn't be located. Checkout for any URL
        misspelling or <a href=\"{{ path('dashboard_page') }}\">return to the homepage</a>.
    </p>
{% endblock %}", "@Twig/Exception/error404.html.twig", "/home/hp/Téléchargements/GRH-master/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}
