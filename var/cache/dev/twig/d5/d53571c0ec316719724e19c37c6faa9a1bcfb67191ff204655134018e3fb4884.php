...
\t\t\t\t\t\t\t\tvalue=\"refuse \" name=\"";
                // line 136
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["conge"], "id", [], "any", false, false, false, 136), "html", null, true);
                echo "\" aria-label=\"Refuser \"
\t\t\t\t\t\t\t\tonclick=\"myFunction2(this.name); \"
\t\t\t\t\t\t\t\thref=\"";
                // line 138
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("conges_refuser", ["id" => twig_get_attribute($this->env, $this->source, $context["conge"], "id", [], "any", false, false, false, 138)]), "html", null, true);
                echo "\" ";
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source,                 // line 139
$context["conge"], "statut", [], "any", false, false, false, 139), "sans décision"))) {
                    echo " style=\"visibility: visible; \" ";
                } else {
                    // line 140
                    echo "\t\t\t\t\t\t\t\tstyle=\"visibility: hidden;\" ";
...
\t\t\t\t\t\t\t\t\taria-label=\"Edit\" href=\"";
            // line 156
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("conges_updateList", ["id" => twig_get_attribute($this->env, $this->source, $context["conge"], "id", [], "any", false, false, false, 156)]), "html", null, true);
            echo "\" ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source,             // line 157
$context["conge"], "statut", [], "any", false, false, false, 157), "sans décision"))) {
                echo " style=\"visibility: visible; \" ";
            } else {
                // line 158
                echo "\t\t\t\t\t\t\t\t\tstyle=\"visibility: hidden;\" ";
...
\t\t\t\t\t\t\t\t\taria-label=\"Delete\" href=\"";
            // line 168
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("conges_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["conge"], "id", [], "any", false, false, false, 168)]), "html", null, true);
            echo "\" ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source,             // line 169
$context["conge"], "statut", [], "any", false, false, false, 169), "sans décision"))) {
                echo " style=\"visibility: visible; \" ";
            } else {
                // line 170
                echo "\t\t\t\t\t\t\t\t\tstyle=\"visibility: hidden;\" ";
