...
<div class=\"container mt-1\">
    <div class=\"card p-3 text-center\">
        ...
        echo "\"
            ...
            <a href=\"";
        // line 178
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("profil_update", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 178, $this->source); })()), "user", [], "any", false, false, false, 178), "name", [], "any", false, false, false, 178), "id", [], "any", false, false, false, 178)]), "html", null, true);
        echo "\"
                class=\"btn shadow-1 rounded-1 btn-outline btn-opening text-airforce text-light-2\"><span
                    class=\"btn-outline-text btn-outline-invert\">Modifier Profil</span></a>
...
";
    ...
    {
        return array (  286 => 178,  279 => 174,  265 => 162,  260 => 159,  252 => 153,  247 => 150,  238 => 143,  233 => 140,  221 => 132,  211 => 125,  196 => 112,  192 => 111,  181 => 103,  174 => 98,  162 => 93,  158 => 92,  68 => 4,  58 => 3,  35 => 1,);
    }
