...
\t\t\t\t\t\t\t\t\t";
                    // line 199
                    if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 199, $this->source); })()), "user", [], "any", false, false, false, 199)) {
                        // line 200
                        echo "\t\t\t\t\t\t\t\t\t\t<td class=\"px-4 py-3 \">
...
\t\t\t\t\t\t\t\t\t\t\t\t   value=\"valide \" name=\"";
                        // line 205
                        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["mission"], "id", [], "any", false, false, false, 205), "html", null, true);
                        echo " \" aria-label=\"Valider \"
\t\t\t\t\t\t\t\t\t\t\t\t   onclick=\"myFunction(this.name); \"
\t\t\t\t\t\t\t\t\t\t\t\t   href=\"";
                        // line 207
                        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mission", ["id" => twig_get_attribute($this->env, $this->source, $context["mission"], "id", [], "any", false, false, false, 207)]), "html", null, true);
                        echo " \" ";
                        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["mission"], "dateFin", [], "any", false, false, false, 207), null))) {
                            // line 208
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"visibility: visible;\" ";
                        } else {
                            echo " style=\"visibility: hidden;\" ";
...
\t\t\t\t\t\t\t\t\t\t\t\t   aria-label=\"Edit\" href=\"";
                        // line 220
                        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mission_update", ["id" => twig_get_attribute($this->env, $this->source, $context["mission"], "id", [], "any", false, false, false, 220)]), "html", null, true);
                        echo " \" ";
                        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source,                         // line 221
$context["mission"], "dateFin", [], "any", false, false, false, 221), null))) {
                            echo " style=\"visibility: visible;\" ";
                        } else {
                            // line 222
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"visibility: hidden;\" ";
...
\t\t\t\t\t\t\t\t\t\t\t\t   aria-label=\"Delete \" href=\"";
                        // line 234
                        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("mission_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["mission"], "id", [], "any", false, false, false, 234)]), "html", null, true);
                        echo " \" ";
                        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source,                         // line 235
$context["mission"], "dateFin", [], "any", false, false, false, 235), null))) {
                            echo " style=\"visibility: visible;\" ";
                        } else {
                            // line 236
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"visibility: hidden;\" ";
...
\t<script src=\"https://cdn.datatables.net/buttons/1.6.4/js/buttons.html5.min.js\"></script>
\t<script src=\"https://cdn.datatables.net/buttons/1.6.2/js/buttons.print.min.js\"></script>
{% endblock %}", "mission/ajax.html.twig", "/home/hp/Téléchargements/GRH-master/templates/mission/ajax.html.twig");
    }
}
