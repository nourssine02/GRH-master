...
class __TwigTemplate_b0ec2a351fa567c8eae18387e6776b3424dd5b4f43841a06ce1488d959b4c820 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
        // line 148
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formA"]) || array_key_exists("formA", $context) ? $context["formA"] : (function () { throw new RuntimeError('Variable "formA" does not exist.', 148, $this->source); })()), "titre", [], "any", false, false, false, 148), 'row', ["label" => false]);
        echo "
\t\t\t\t\t\t</label>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t";
        // line 155
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formA"]) || array_key_exists("formA", $context) ? $context["formA"] : (function () { throw new RuntimeError('Variable "formA" does not exist.', 155, $this->source); })()), "contenu", [], "any", false, false, false, 155), 'row', ["label" => false]);
        echo "
...
\t\t\t\t\t\t\t";
        // line 165
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formA"]) || array_key_exists("formA", $context) ? $context["formA"] : (function () { throw new RuntimeError('Variable "formA" does not exist.', 165, $this->source); })()), "date", [], "any", false, false, false, 165), 'row', ["label" => false]);
        echo "
...
\t<div class=\"tab-content\">
\t\t<form action=\"{{ path('annonce_new')}}\" method=\"post\">
...
{% endblock %}", "annonce/new.html.twig", "/home/hp/Téléchargements/GRH-master/templates/annonce/new.html.twig");
    }
}
